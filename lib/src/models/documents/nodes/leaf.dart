...
abstract class Leaf extends Node {
  ...
  /// [EmbedLeaf] if this is an [BlockEmbed].
...
/// See also:
///
///   * [EmbedLeaf], a leaf node representing an embeddable object.
...
class EmbedLeaf extends Leaf {
  EmbedLeaf(Embeddable data) : super.val(data);
