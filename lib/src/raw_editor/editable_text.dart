...
class ExtendedEditableText extends StatefulWidget {
  ...
  ///
  /// See [ExtendedRenderEditable.locale] for more information.
  final Locale? locale;
  ...
  /// If true, the [ExtendedRenderEditable] created by this widget will not handle
  /// pointer events, see [ExtendedRenderEditable] and [ExtendedRenderEditable.ignorePointer].
  ///
  ...
  ///
  /// If this property is null, [ExtendedRenderEditable.preferredLineHeight] will be used.
  /// {@endtemplate}
  ...
  /// [ExtendedRenderEditable.selectionEnabled].
  /// {@endtemplate}
  ...
  @override
  LuckyEditableTextState createState() => LuckyEditableTextState();
